...
(defmethod driver/describe-database :vertica [_ driver database]
  (update (driver/describe-database :sql-jdbc database) :tables (u/rpartial set/union (materialized-views database))))

(defmethod sql.qp/string-length-fn :vertical [_ field-key]
